...
COMMENT ON TABLE "public"."todo" IS 'Todo table';
...
CREATE POLICY "Enable insert for authenticated users only" ON "public"."todo" FOR INSERT TO "authenticated" WITH CHECK (true);



CREATE POLICY "Enable read access for all users" ON "public"."todo" FOR SELECT USING (true);
